...
/**
 * Created by hitesh.grover on 13/07/17.
 */
@CucumberOptions(
        monochrome = true,
        features = "src/test/resources/curbside/features/android/ProductCatalog.feature",
...
@Test
public class ProductCatalog extends AbstractTestNGCucumberTests {
