...
/**
 * Created by hitesh.grover on 18/07/17.
 */
@CucumberOptions(
        monochrome = true,
        features = "src/test/resources/curbside/features/android/LiveOrder.feature",
...
@Test
public class LiveOrderTest extends AbstractTestNGCucumberTests{
}
