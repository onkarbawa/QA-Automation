...
@CucumberOptions(
        monochrome = true,
        features = "src/test/resources/curbside/features/ios/features/MailVerification.feature",
...
@Test
public class MailNotificationTest extends AbstractTestNGCucumberTests {
}
