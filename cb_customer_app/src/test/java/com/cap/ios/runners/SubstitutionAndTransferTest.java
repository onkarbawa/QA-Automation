...
@CucumberOptions(
        monochrome = true,
        features = "src/test/resources/cap/features/ios/features/SubstitutionAndTransferOrder.feature",
...
@Test
public class SubstitutionAndTransferTest extends AbstractTestNGCucumberTests {
}
