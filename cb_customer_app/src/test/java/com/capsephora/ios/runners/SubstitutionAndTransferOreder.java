...
@CucumberOptions(
        monochrome = true,
        features = "src/test/resources/capsephora/features/ios/SubstitutionAndTransferOrder.feature",
...
@Test
public class SubstitutionAndTransferOreder extends AbstractTestNGCucumberTests {
}
